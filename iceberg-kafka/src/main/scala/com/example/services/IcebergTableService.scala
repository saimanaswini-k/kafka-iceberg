...
class IcebergTableService(spark: SparkSession) {
  ...
  private val tableLocation = "file:///Users/apple/Desktop/iceberg-kafka/data/warehouse/iceberg/taxi-data"
  
  // The catalog reference using spark_catalog
  private val catalogTableName = "spark_catalog.iceberg.taxi-data"
